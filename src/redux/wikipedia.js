...
export const searchSuccessAction = (searchResult, offset) => ({type: SEARCH_SUCCESS, searchResult, offset});
...
export default function reducer(state = initialState, action = {}) {
    ...
    switch (action.type) {
        ...
        case SEARCH_SUCCESS:
            return {
                ...state,
                searchResult: (action.offset === 0) ? action.searchResult : state.searchResult.concat(action.searchResult),
                searchPending: false,
            };
        case SEARCH_FAILURE:
            return {
